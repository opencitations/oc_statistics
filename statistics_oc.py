        ...
        if date != "last-month":
            if self.__dates_regex.match(date):
                ...
                metrics = {
                    ...
                    'api_skgif_requests': Counter('opencitations_api_skgif_requests', 'Total SKG-IF API requests', registry=registry),
                                ...
                                for family in text_fd_to_metric_families(f):
                                    for sample in family.samples:
                                        ...
                                        mapping = {
                                            ...
                                            'opencitations_api_skgif_requests_total': ('api_skgif_requests', None),
